...
define('DB_NAME', 'wp_blog');//notepadi_db

/** MySQL database username */
define('DB_USER', 'root');

/** MySQL database password */
define('DB_PASSWORD', ''); //cffl~65I{5Pc

/** MySQL hostname */
define('DB_HOST', 'localhost'); //52.77.27.86
...
// define('COOKIE_DOMAIN', '.notepad.iktutor.com');
// define('COOKIEPATH', '/');

define( 'WP_HOME', 'http://localhost:86/wp_3i/');
define( 'WP_SITEURL', 'http://localhost:86/wp_3i/');
