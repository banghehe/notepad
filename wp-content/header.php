		...
		<div id="container">
			...
			<header class="header" itemscope itemtype="http://schema.org/WPHeader">
				...
				<div class="container" style="position: relative">
					...
					<div id="sub-logo">
						<a href="http://www.ikstudy.com/<?php echo $lang; ?>" rel="nofollow" title="Innovative Knowledge">
					...
					<ul id="user-nav">						
						<?php if ($is_user_logged_in) : ?>
							<li><a class="display-name" href="<?php echo site_home_url() ?>/?r=my-account">[<?php echo $current_user->display_name ?>]</a></li>
						<?php endif ?>
							<li><a class="shopping-cart" href="<?php echo home_url_ssl() ?>/?r=payments" title="<?php _e('Shopping Cart', 'iii-dictionary') ?>"><span class="icon-cart2"></span>(<?php echo count($cart_items) ?>)</a></li>
							<li><a href="http://www.ikstudy.com/<?php echo $lang; ?>" title="<?php _e('Home', 'iii-dictionary') ?>"><?php _e('Home', 'iii-dictionary') ?><span class="home-icon"></span></a></li>
						<?php if (!$is_user_logged_in) : ?>
							<li><a href="<?php echo site_home_url() ?>/?r=login" title="<?php _e('Login', 'iii-dictionary') ?>"><?php _e('Login', 'iii-dictionary') ?><span class="login-icon"></span></a></li>
							<li><a class="sign-up-link" href="<?php echo site_home_url() ?>/?r=signup" title="<?php _e('Sign-up', 'iii-dictionary') ?>"><?php _e('Sign-up', 'iii-dictionary') ?><span class="signup-icon"></span></a></li>
						<?php else : ?>
							<li><a class="logout-link" href="<?php echo wp_logout_url(home_url()) ?>" title="<?php _e('Logout', 'iii-dictionary') ?>"><?php _e('Logout', 'iii-dictionary') ?><span class="login-icon"></span></a></li>
						<?php endif ?>
					</ul>
