...
<div class="block-image fl">
	...
	<p id="icon-screenshot" class="tooltip-wrap">
	...
	<p id="icon-video" class="tooltip-wrap">
		<img src="<?php echo III_NOTEPAD_PLUGIN_DIR_URL; ?>assets/images/notepad/upload_video_player.png" />
		<span class="hidden tooltip-icon">
			<span class="h"><?php echo esc_html__('Video', 'iii-notepad'); ?></span>
			<span class="t"><?php echo esc_html__('Insert video from the Youtube', 'iii-notepad'); ?></span>
		</span>
	</p>
