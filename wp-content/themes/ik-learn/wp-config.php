...
define('DB_NAME', 'ikstudy_ik2017');

/** MySQL database username */
define('DB_USER', 'ikstudy_ik2017');

/** MySQL database password */
define('DB_PASSWORD', 'Ikdb2017');
...
define('COOKIE_DOMAIN', '.ikteacher.com');
define('COOKIEPATH', '/');

define('WP_SITEURL', 'http://ikteacher.com');
define('WP_HOME', 'http://ikteacher.com');
